...
public class ImageProcessor {
    ...
    /**
     * Changes the bow color from green to a specified new color using a 3D array.
     * 
     * @param pixelArray The 3D array of pixel data.
     * @param newColor   The new RGB color values.
     */
    // TODO: Change the bow color from green to a given color
    public static void changeBowColor(/* TODO type pixelArray, */ int[] newColor) {
        int height = 0; // TODO height of the pixelArray
        int width = 0; // TODO width of the pixelArray

        for (int y = 0; y < height; y++) {
            for (int x = 0; x < width; x++) {
                // TODO: If the current pixel is green, change the color (RGB)
                // if (isGreen(pixelArray[y][x])) {
                // ...
                // }
            }
        }
